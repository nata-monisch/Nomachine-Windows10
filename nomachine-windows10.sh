wget -O ng.sh https://raw.githubusercontent.com/nata-monisch/Nomachine-Windows10/main/ngrok.sh > /dev/null 2>&1
chmod +x ng.sh
./ng.sh
...
clear
echo "Repo: https://github.com/nata-monisch/Nomachine-Windows10"
echo "======================="
